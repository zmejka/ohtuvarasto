...
class TestVarasto(unittest.TestCase):
    ...
    def test_uusi_varasto_vaara_tilavuus(self):
        uusi_varasto = Varasto(-1)
        self.assertAlmostEqual(uusi_varasto.tilavuus, 0)
    
    def test_uusi_varasto_alku_saldo_vaara(self):
        uusi_varasto = Varasto(1,-1)
    ...
    def test_lisays_yli_vapaa_tila(self):
    ...
    def test_ottaminen_negatiivinen_maara(self):
        self.varasto.lisaa_varastoon("a")
        self.assertAlmostEqual(self.varasto.ota_varastosta(-1), 0)
    
    def test_ottaaminen_yli_saldon(self):
        self.varasto.lisaa_varastoon(8)
        self.assertAlmostEqual(self.varasto.ota_varastosta(20), 8)
